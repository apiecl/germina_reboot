...
(function ($){
	...
	searchInPlace.prototype = {
		...
		getResults : function(e){
			...
			s.appendTo('div.live-search-results');
			me.displayLoading(s);
		...
		displayResult : function(o, e){
			...
			for(var t in o){
				...
				for(var i=0, h = l.length; i < h; i++){
					s += '<div class="item">'; 
					if(l[i].thumbnail){ 
						s += '<div class="thumbnail"><img src="'+l[i].thumbnail+'" /></div><div class="data">';
					}else{
						s += '<div class="data">';
					}	
		...
		displayLoading : function(e){
			e.append('<div class="label"><div class="loading"><i class="fa fa-spin fa-cog fa-2x"></i> buscando</div></div>');
		},
