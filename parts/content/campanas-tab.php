...
<a class="btn btn-info vertodos" href="<?php echo esc_url( add_query_arg('proy', 'y', get_term_link('campanas', 'areas')) );?>" title="Ver todos los proyectos del área">Ver todos <i class="fa fa-angle-right"></i></a>
