...
<div class="panel-group tax-filter" id="taxonomy-accordion" role="tablist" aria-multiselectable="true">
	...
	$childtermsarray = [];
	$taxonomies = ['areas', 'ambitos_de_accion', 'tema', 'germina_year', 'estado'];
			...
			<div class="panel-collapse collapse" role="tabpanel" aria-labelledby="heading-<?php echo $taxonomy;?>" id="taxpanel-<?php echo $taxonomy;?>">
				<div class="panel-body">
					<?php foreach($terms as $term) {
						...
						?>
						<a href="#" class="btn btn-large btn-filter btn-default <?php echo $childterms ? 'childterms-call' : 'proyect-call';?>" data-reuse="0" data-termslug="<?php echo $term->slug;?>" data-term="<?php echo $term->term_id;?>" data-tax="<?php echo $taxonomy;?>"><?php echo $term->name;?> <?php echo $childterms ? '<i class="fa fa-chevron-down"></i>' : '' ;?></a>
						<?php
		...
		<div class="panel panel-default subpanel hidden" id="childpanel-<?php echo $parent_term->slug;?>">
			...
			<div class="panel-collapse collapse in" role="tabpanel" aria-labelledby="heading-<?php echo $parent_term->slug;?>" id="subtermpanel-<?php echo $parent_term->slug;?>">
				...
				<?php foreach($childtermsarray[$key] as $childterm) {
					...
					<a href="#" class="btn btn-large btn-filter btn-default proyect-call" data-reuse="0" data-term="<?php echo $childterm->term_id;?>" data-tax="<?php echo $childterm->taxonomy;?>"><?php echo $childterm->name;?></a>
