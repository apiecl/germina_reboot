				...
				<div class="panel panel-default">
					<div class="panel-heading active" role="tab" id="heading-descending">
						<h4 class="panel-title">
							<a class="ajax-sort-button proyect-call" data-item-template="<?php echo $template;?>" data-sort="descending" role="button" data-sort-label="recientes">Más recientes</a>
						</h4>
					</div>
				</div>
				<div class="panel panel-default">
					<div class="panel-heading" role="tab" id="heading-ascending">
						<h4 class="panel-title">
							<a class="ajax-sort-button proyect-call" data-item-template="<?php echo $template;?>" data-sort="ascending" role="button" data-sort-label="antiguos">Más antiguos</a>
						</h4>
					</div>
				</div>
			</div>
